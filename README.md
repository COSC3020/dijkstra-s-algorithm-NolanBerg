...
As both the enqueuing of vertices (once per edge) and the dequeuing (once per vertex) involve logarithmic operations, we have a $\Theta$ time complexity of $\Theta((E + V) \log V)$. This assumes that the graph is connected and $E \geq V$.
